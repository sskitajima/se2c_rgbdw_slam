...
void graph_node::update_connections() {
    ...
    //// 現在のKFとcovisibility関係にあるKFの重みを求める ////
    // 特定のKFが持つランドマークすべてについてループ
    ...
    //// 重みの最大値を求め、閾値weight_thr_以上のもののみ保存する ////
    // vector for sorting
    ...
    //// 重みに基づき、現在のKFからcovisibility関係を築く ////
    ...
    //// 重みとKFを保持している変数を、重みとKFに分離して、このクラスに保存する ////
    // sort with weights
