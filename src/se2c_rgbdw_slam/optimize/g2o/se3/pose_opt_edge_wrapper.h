...
#include "se2c_rgbdw_slam/optimize/g2o/se3/perspective_pose_opt_edge.h"
#include "se2c_rgbdw_slam/optimize/g2o/se3/equirectangular_pose_opt_edge.h"
...
public:
    ...
    pose_opt_edge_wrapper(T* shot, shot_vertex* shot_vtx, const Vec3_t& pos_w,
                          ...
                          const float inv_sigma_sq, const float sqrt_chi_sq, const unsigned int num_observed);
