...
#include "se2c_rgbdw_slam/optimize/g2o/sim3/forward_reproj_edge.h"
#include "se2c_rgbdw_slam/optimize/g2o/sim3/backward_reproj_edge.h"
...
public:
    ...
    mutual_reproj_edge_wapper(T* shot1, unsigned int idx1, data::landmark* lm1,
                              ...
                              g2o::sim3::transform_vertex* Sim3_12_vtx, const float sqrt_chi_sq, const unsigned sum_num_obs);
    ...
    // 1. forward edgeを作成
    {
        ...
        switch (camera1->model_type_) {
            case camera::model_type_t::Perspective: {
                ...
                // edge_12->setInformation(Mat22_t::Identity() * inv_sigma_sq_1 * sum_num_obs);
    ...
    // 2. backward edgeを作成
    {
        ...
        switch (camera2->model_type_) {
            case camera::model_type_t::Perspective: {
                ...
                // edge_21->setInformation(Mat22_t::Identity() * inv_sigma_sq_2 * sum_num_obs);
