...
#include "se2c_rgbdw_slam/optimize/g2o/sim3/shot_vertex.h"
#include "se2c_rgbdw_slam/optimize/g2o/sim3/graph_opt_edge.h"
...
void graph_optimizer::set_se2c_wrappers(std::shared_ptr<optimize::g2o::se2c::plane_constraint_wrapper>& plane_wrapper, std::shared_ptr<optimize::g2o::se2c::odometry_constraint_wrapper>& odom_wrapper)
{
