...
#include "se2c_rgbdw_slam/optimize/transform_optimizer.h"
#include "se2c_rgbdw_slam/optimize/g2o/sim3/transform_vertex.h"
#include "se2c_rgbdw_slam/optimize/g2o/sim3/mutual_reproj_edge_wrapper.h"
...
unsigned int transform_optimizer::optimize(data::keyframe* keyfrm_1, data::keyframe* keyfrm_2,
    ...
    for (unsigned int idx1 = 0; idx1 < num_matches; ++idx1) {
        ...
        const unsigned int num_observed1 = lm_1->num_observations();
        const unsigned int num_observed2 = lm_2->num_observations();
        reproj_edge_wrapper mutual_edge(keyfrm_1, idx1, lm_1, keyfrm_2, idx2, lm_2, Sim3_12_vtx, sqrt_chi_sq, num_observed1+num_observed2);
