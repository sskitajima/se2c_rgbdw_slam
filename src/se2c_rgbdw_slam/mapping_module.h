...
#include "se2c_rgbdw_slam/module/local_map_cleaner.h"
...
public:
    ...
    //! Proposed
    void set_octomap_mappoing_module(module::octomap_mapping* octomap_mapping);
...
private:
    ...
    //! Proposed octomap
    module::octomap_mapping* octomap_mapping_;
};
