...
#include "se2c_rgbdw_slam/module/two_view_triangulator.h"
#include "se2c_rgbdw_slam/solve/essential_solver.h"
...
void mapping_module::set_octomap_mappoing_module(module::octomap_mapping* octomap_mapping)
{
    octomap_mapping_ = octomap_mapping;
}

void mapping_module::set_se2c_wrappers(std::shared_ptr<optimize::g2o::se2c::plane_constraint_wrapper>& plane_wrapper, std::shared_ptr<optimize::g2o::se2c::odometry_constraint_wrapper>& odom_wrapper)
{
    local_bundle_adjuster_->set_se2c_wrappers(plane_wrapper, odom_wrapper);    
}
...
void mapping_module::mapping_with_new_keyframe() {
    ...
    // const auto t_local_BA = std::chrono::system_clock::now();
