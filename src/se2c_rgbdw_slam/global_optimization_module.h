...
#include "se2c_rgbdw_slam/module/loop_detector.h"
#include "se2c_rgbdw_slam/module/loop_bundle_adjuster.h"
#include "se2c_rgbdw_slam/optimize/graph_optimizer.h"
...
public:
    ...
    //! Set the octomap mapping module
    void set_octomap_mapping_module(module::octomap_mapping* octomap_mapping);
...
private:
    ...
    //! Proposed
    // thread for octomap reconstruction
    std::unique_ptr<std::thread> thread_for_octomap_reconstruction_ = nullptr;
};
